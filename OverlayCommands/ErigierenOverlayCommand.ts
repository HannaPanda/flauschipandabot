...
class ErigierenOverlayCommand extends AbstractOverlayCommand
{
    isActive       = true;
    isModOnly      = false;
    isOwnerOnly    = false;
    command        = "erigieren";
    aliases        = [];
    description    = "Erigieren";
    mediaFile      = "erigieren2.mp3";
    mediaType      = "audio";
    volume         = 0.5;
...
let erigierenOverlayCommand = new ErigierenOverlayCommand();

export default erigierenOverlayCommand;