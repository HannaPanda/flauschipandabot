...
class WeirdOverlayCommand extends AbstractOverlayCommand
{
    isActive       = true;
    isModOnly      = false;
    isOwnerOnly    = false;
...
let weirdOverlayCommand = new WeirdOverlayCommand();

export default weirdOverlayCommand;