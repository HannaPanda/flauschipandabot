...
class SchnitzelOverlayCommand extends AbstractOverlayCommand
{
    isActive       = true;
    isModOnly      = false;
    isOwnerOnly    = false;
    command        = "schnitzel";
    aliases        = [];
    description    = "Du Fickschnitzel";
    mediaFile      = "fickschnitzel.mp3";
    mediaType      = "audio";
    volume         = 0.5;
...
let schnitzelOverlayCommand = new SchnitzelOverlayCommand();

export default schnitzelOverlayCommand;