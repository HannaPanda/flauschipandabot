...
class KaffeeOverlayCommand extends AbstractOverlayCommand
{
    isActive       = true;
    isModOnly      = false;
    isOwnerOnly    = false;
    command        = "kaffee";
    aliases        = [];
    description    = "Kaffee, Junge";
    mediaFile      = "kaffee.mp3";
    mediaType      = "audio";
    volume         = 0.5;
...
let kaffeeOverlayCommand = new KaffeeOverlayCommand();

export default kaffeeOverlayCommand;