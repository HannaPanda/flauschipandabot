...
class SeitenbacherOverlayCommand extends AbstractOverlayCommand
{
    isActive       = true;
    isModOnly      = false;
    isOwnerOnly    = false;
    command        = "seitenbacher";
    aliases        = [];
    description    = "Seitenbacher!";
    mediaFile      = "seitenbacher.mp3";
    mediaType      = "audio";
    volume         = 0.5;
...
let seitenbacherOverlayCommand = new SeitenbacherOverlayCommand();

export default seitenbacherOverlayCommand;