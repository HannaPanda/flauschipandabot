...
class PeitscheOverlayCommand extends AbstractOverlayCommand
{
    isActive       = true;
    isModOnly      = false;
    isOwnerOnly    = false;
...
let peitscheOverlayCommand = new PeitscheOverlayCommand();

export default peitscheOverlayCommand;