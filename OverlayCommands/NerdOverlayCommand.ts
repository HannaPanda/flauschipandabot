...
class NerdOverlayCommand extends AbstractOverlayCommand
{
    isActive       = true;
    isModOnly      = false;
    isOwnerOnly    = false;
...
let nerdOverlayCommand = new NerdOverlayCommand();

export default nerdOverlayCommand;